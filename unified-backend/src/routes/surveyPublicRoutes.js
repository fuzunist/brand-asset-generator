// unified-backend/src/routes/surveyPublicRoutes.js
...
// GET /surveys/:id - Get survey data for widget
...
// POST /surveys/:id/vote - Submit a vote
router.post('/surveys/:id/vote', async (req, res, next) => {
    try {
        const { id } = req.params;
...
// GET /surveys/:id/results - Get public results
router.get('/surveys/:id/results', async (req, res, next) => {
    try {
        const { id } = req.params;
